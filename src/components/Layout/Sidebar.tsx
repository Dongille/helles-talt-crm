...
import { LayoutDashboard, Calendar, Package, FileText, CalendarCheck, BarChart2, Archive, Receipt, Bell, Users, X, LogOut } from 'lucide-react';
...
const navItems = [
  ...
  { to: '/loggbok',     label: 'Loggbok',     icon: Bell,     end: false },
