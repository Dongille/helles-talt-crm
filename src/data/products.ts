...
export const PRODUCTS: ProductDefinition[] = [
  ...
  // Partytält Pro
  { id: 'talt-pro-4x8', name: 'Partytält pro 5x10 m', category: 'Partytält', subcategory: 'Partytält Pro', basePrice: 3900, montagePrice: 3200, hasMontage: true },
  { id: 'talt-pro-6x12', name: 'Partytält pro 6x12 m', category: 'Partytält', subcategory: 'Partytält Pro', basePrice: 4800, montagePrice: 4100, hasMontage: true },
  ...
  { id: 'overdrag-stabord-vit', name: 'Överdragsstrumpa – Vit', category: 'Möbler – Dukar & Överdrag', basePrice: 115, montagePrice: 10, hasMontage: true },
  { id: 'overdrag-stabord-svart', name: 'Överdragsstrumpa – Svart', category: 'Möbler – Dukar & Överdrag', basePrice: 115, montagePrice: 10, hasMontage: true },
  ...
  // Festutrustning & Övrigt
  { id: 'golv-m2', name: 'Golv m²', category: 'Festutrustning & Övrigt', basePrice: 50, montagePrice: 35, hasMontage: true },
